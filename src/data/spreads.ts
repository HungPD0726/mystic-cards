...
export const spreads: SpreadConfig[] = [
  {
    ...
    cardCount: 1,
    positions: [
      { id: 'message', label: 'Thông điệp', description: 'Thông điệp chính cho bạn' },
    ],
    icon: '🃏',
  },
  {
    id: 'three-card',
    name: 'Ba Lá',
    description: 'Trải bài ba lá kinh điển: Quá khứ – Hiện tại – Tương lai. Giúp bạn hiểu bức tranh tổng thể.',
    cardCount: 3,
    positions: [
  ...
  },
  {
    ...
    cardCount: 1,
    positions: [
      { id: 'answer', label: 'Câu trả lời', description: 'Upright = Có, Reversed = Không' },
    ],
    icon: '⚖️',
  },
];
